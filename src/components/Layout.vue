<template>
    <div class="layout">
        ...
        <div class="footbar">
            <div class="icons2">
                <el-row :gutter="20">
                    <Icons2 footbarName="service" :iconName="serviceIcon" text="Services" />
                    <Icons2 footbarName="course" :iconName="courseIcon" text="Technical Classroom" />
                    <Icons2 footbarName="user" :iconName="userIcon" text="About" />
                </el-row>
            </div>
        </div>
    </div>
